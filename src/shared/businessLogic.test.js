...
describe("handleDeltaBids", () => {
  it("should sum up quote size from highest price quote to the lowest", () => {
    ...
    expect(handleDeltaBids([], from)).toEqual(to);
  });
  ...
  it("should add newQuotesTemp ", () => {
    ...
    const result = handleDeltaBids(oldFrom, from, newQuotesTemp);
  ...
  it("should changedSizesTemp decrease", () => {
    ...
    const result = handleDeltaBids(oldFrom, from, {}, changedSizesTemp);
